...
export declare const GOOGLE_OAUTH2_SEND_URL = "https://accounts.google.com/o/oauth2/v2/auth?access_type=offline&client_id={client_id}&redirect_uri={redirect_uri}&response_type=code&state={state}&scope=openid%20email%20profile";
