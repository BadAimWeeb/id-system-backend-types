...
export declare const p: {
    input: <TIn>(parser: {
        ...
        resolve: <TOut>(oCallback: (gState: GlobalState, lState: Partial<LocalState>, input: TIn, socket: import("@badaimweeb/js-dtsocket/dist/server_csocket.js").DTSocketServer_CSocket<ServerContext<GlobalState, LocalState, EventTable, Session<WebSocket & {
            req: IncomingMessage;
        }>>, Session<WebSocket & {
            req: IncomingMessage;
        ...
        streamResolve: <TOut_1>(oCallback: (gState: GlobalState, lState: Partial<LocalState>, input: TIn, socket: import("@badaimweeb/js-dtsocket/dist/server_csocket.js").DTSocketServer_CSocket<ServerContext<GlobalState, LocalState, EventTable, Session<WebSocket & {
            req: IncomingMessage;
        }>>, Session<WebSocket & {
            req: IncomingMessage;
